                  ...
                  <div class="card-panel">
                    ...
                    <div class="row">
                      <div class="col s12">
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                              <button class="btn cyan waves-effect waves-light right"  name="action" onclick="CreateShop()" >Submit
		...
		function CreateShop()
		{
			...
			var phone_number = document.getElementById("phone_number").value;
				...
				else 
				{
					...
					$.post("../api/v1/createshopweb", {name: shopname, mobile_number: mobile_number, phone_number: phone_number}, 
					function(result){
