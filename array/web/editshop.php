...
<body>
			...
			<!--card stats start-->
			 ...
			 <div class="col s12 m12 l6">
                  <div class="card-panel">
                    <h4 class="header2">Update Logo</h4>
                    <div class="row">
					<form id="form_logo" method="post" action="" enctype="multipart/form-data">
					
                      <div class="col s12">
                        <div class="row">
                           <div class="card-image">
									<div class="col s12 m2">
									<img id="view_logo" class="responsive-img" src="../api/logo_brand/<?php echo $shopDetail->logo;?>">
                        ...
                        <div class="row">
                          <div class="input-field col s12">
								<div class="file-field input-field">
									<div class="btn">
										<span>Pick</span>
										<input id="logo_shop" name="logo_shop" type="file" accept="image/x-png, image/jpeg" onchange="readURL(this)">
									</div>
									<div class="file-path-wrapper">
										<input class="file-path validate" type="text" placeholder="Image logo">
									</div>
								</div>
							</div>
                        </div>
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                              <button class="btn cyan waves-effect waves-light right"  name="action"  >Update
                    ...
                    <div class="col s12 m12 l6">
                  <div class="card-panel">
                    <h4 class="header2">Create SHOP</h4>
                    <div class="row">
                      <div class="col s12">
                        <div class="row">
                          <div class="input-field col s12">
                            <input id="shopname" name="shopname" value="<?php echo $shopDetail->name;?>" type="text">
                            <label for="shopname">Shop Name</label>
                          </div>
                        </div>
                        <div class="row">
                          <div class="input-field col s12">
                            <input id="mobile_number" name="mobile_number" value="<?php echo $shopDetail->mobile_number;?>" type="text">
                            <label for="mobile_number">Mobile number</label>
                          </div>
                        </div>
                        <div class="row">
                          <div class="input-field col s12">
                            <input id="phone_number" name="phone_number" value="<?php echo $shopDetail->phone_number;?>" type="text">
                            <label for="phone_number">Phone number</label>
                          </div>
                        </div>
                        <div class="row">
                            <div class="input-field col s12">
                              <button class="btn cyan waves-effect waves-light right"  name="action" onclick="EditShop()" >Update
                                <i class="mdi-content-send right"></i>
                              </button>
                            </div>
                        </div>
  ...
  $(document).ready(function (e) {
			...
			$("#form_logo").on('submit',(function(e) {
					...
					$.ajax({
					url: "../api/v1/updatelogoweb", // Url to which the request is send
		...
		function EditShop()
		{
			...
			var phone_number = document.getElementById("phone_number").value;
				...
				else 
				{
					...
					$.post("../api/v1/editshopweb", {name: shopname, mobile_number: mobile_number, phone_number: phone_number}, 
					function(result){
