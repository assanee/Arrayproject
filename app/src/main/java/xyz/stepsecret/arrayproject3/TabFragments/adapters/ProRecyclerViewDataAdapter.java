...
public class ProRecyclerViewDataAdapter extends RecyclerView.Adapter<ProRecyclerViewDataAdapter.ItemRowHolder> {

    private ArrayList<ProSectionDataModel> dataList;
    private Context mContext;

    public ProRecyclerViewDataAdapter(Context context, ArrayList<ProSectionDataModel> dataList) {
    ...
    public ItemRowHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.pro_list_item, null);
